	...
	<div id="demo-container">
		...
		<form id="devFrm" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input class="form-contorl" type="date" name="birthday" >
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					...
					onclick="requestSend('demo/demo1.do')">서블릿 이용해보기</button>
				</div>
				...
				<div class="col-sm-12">
					<button type="button" class="col-sm-12 btn btn-outline-primary"
					onclick="requestSend('demo/demo2.do')">1:1 로 매핑해서 데이터 받기</button>
				</div>
				...
				<div class="col-sm-12">
					<button type="button" class="col-sm-12 btn btn-outline-primary"
					onclick="requestSend('demo/demo3.do')">@RequestParam 사용하기</button>
				</div>
				
				<div class="col-sm-12">
					<button type="button" class="col-sm-12 btn btn-outline-primary"
					onclick="requestSend('demo/demo4.do')">vo  객체로 바로받기</button>
				</div>
				...
				<div class="col-sm-12">
					<button type="button" class="col-sm-12 btn btn-outline-primary"
					onclick="requestSend('demo/demo6.do')">추가 데이터 확인</button>
				</div>
				...
				<div class="col-sm-12">
					<button type="button" class="col-sm-12 btn btn-outline-primary"
					onclick="requestSend('demo/insertDemo.do')"> insertTest 반환하기 </button>
				</div>
				
				<div class="col-sm-12">
					<button type="button" class="col-sm-12 btn btn-outline-primary"
					onclick="requestSend('demo/demolist.do')"> 전체조회 하자 </button>
				</div>
