...
<section id="content">
	<div id="demo-container">
		<h2>Demo 수정 페이지</h2>
		<form id="devFrm" method="post"   action="${path}/demo/demoupdateEnd.do">
			<div class="form-group row">
			<label for="devName" class="col-sm-2 col-form-label">이름</label>
			<div class="col-sm-10">
				<input type="hidden" class="form-control" id="devNo" name="devNo"
				value="${demo.devNo}">
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<button type="submit" class="col-sm-12 btn btn-outline-primary">수정완료</button>
				</div>				
			</div>
		</form>
	</div>
